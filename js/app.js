...
if (person !== null) {
    ...
    document.getElementById("welcome-message").innerHTML =
        "Hello " +
        person +
        "! How are you today? <br /><br /> Let's test how strong is your memory " +
        person +
        "!<br /><br /> If you don`t finish the game under 16 moves you`ll start losing stars.";
}
...
document.body.addEventListener("click", function(e) {
    ...
    if (
        ...
        document.querySelectorAll(".reveal").length < 2
    ) {
...
function winCheck() {
    if (matchedCardsCount === 8) {
        ...
        if (moveCount > 27) {
            document.getElementById("star-rating-message").innerHTML =
                "No stars :( Try to complete in less moves next time " + person + ".";
        }
    }
    closeModal();
}
...
function displayTime(clock) {
    ...
    secondsFormatted =
        secondsRounded < 10 ? "0" + secondsRounded : secondsRounded;
...
function adjustStars() {
    ...
    if (moveCount > 16) {
        starRating.innerHTML =
            "<li><i class='fa fa-star'></i></li><li><i class='fa fa-star'></i></li><li><i class='fa fa-star' style='color:#d3d3d3'></i></li>";
    }
    if (moveCount > 24) {
        starRating.innerHTML =
            "<li><i class='fa fa-star'></i></li><li><i class='fa fa-star' style='color:#d3d3d3'></i></li><li><i class='fa fa-star' style='color:#d3d3d3'></i></li>";
    }
    if (moveCount > 26) {
        starRating.innerHTML =
            "<li><i class='fa fa-star' style='color:#d3d3d3'></i></li><li><i class='fa fa-star' style='color:#d3d3d3'></i></li><li><i class='fa fa-star' style='color:#d3d3d3'></i></li>";
    }
